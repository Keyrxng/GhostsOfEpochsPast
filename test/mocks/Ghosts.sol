...
//         userIdToFollowed[address(this)].push(0); // tests UserId
//         userIdToFollowers[address(this)].push(0); // tests UserId
//     }
...
//             0, // contentPosts
//             0, // ctfStbContribs
//             id, // CyberConnect Profile ID // ghosts for tests
//             id // Ghosts User ID
//         );
//         userMap[msg.sender] = user;
//         idToUser[id] = user;

//         userAwardFeats(0, 0, msg.sender, id);
