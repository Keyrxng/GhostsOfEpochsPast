...
contract GhostsTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory payload = abi.encodeWithSignature("initialize(bytes32[])", answers);
        ...
        hashess[6] = 'sdd';
        hashess[7] = 'dsa';
        wrappedProxyV1.ccAchievementMaker("test", "test", hashess, "desc", 10, 1);
    ...
    function test_CreateUser() external {
        ...
        (address addr, uint raceId, uint collabId, uint comTask, uint perf, uint stbs, uint posts, uint contribs, uint ccID, uint ghostsID) = wrappedProxyV1.userMap(user4);
    ...
    function test_SubmitRace() external {
        ...
        (, uint collabIdd, uint raceIdd,,,,,,,) = wrappedProxyV1.userMap(user4);
        ...
        (,,uint raceId1, ,,,, ,,) = wrappedProxyV1.userMap(user4);
        assertEq(raceId, 2);
    ...
    function test_AddCollab() external {
      string[] memory hashs = new string[](2);
        ...
        (,,,,,uint stb,,uint contribs,,) = wrappedProxyV1.userMap(user4);
